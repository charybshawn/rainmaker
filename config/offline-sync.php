...
return [
    ...
    */
    'models' => [
        ...
        // Note: Company, Category, and Tag models should also be synced
        // to ensure relationships work on remote server
        \App\Models\Company::class => [
            ...
            'exclude_fields' => [],
            'sync_deletes' => false, // Don't delete companies
            'priority' => 2, // Sync companies before research items
        ],
        ...
        \App\Models\Category::class => [
            ...
            'exclude_fields' => [],
            'sync_deletes' => false,
            'priority' => 3, // Sync categories before research items
        ],
        ...
        \App\Models\Tag::class => [
            ...
            'exclude_fields' => [],
            'sync_deletes' => false,
            'priority' => 3, // Sync tags before research items
        ],
    ],
