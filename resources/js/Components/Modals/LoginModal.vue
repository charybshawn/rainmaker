        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            ...
            >
                ...
                <div class="absolute top-0 right-0 pt-4 pr-4">
                    <button
                        type="button"
                        class="bg-white/10 rounded-md p-2 inline-flex items-center justify-center text-white/60 hover:text-white hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-200"
                        @click="closeModal"
                    >
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <button
                                    ...
                                    type="button"
                                    class="text-sm text-white/60 underline hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
                                >
